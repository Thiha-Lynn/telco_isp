                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                           ...
                           <a class="btn btn-danger"  href="{{ route('admin.install_query',app()->getLocale()) }}" role="button">Back</a>
                        ...
                        <!-- /.card-header -->
                          ...
                          <div id="demo" class="display">
                           <table id="installquery" class="display nowrap  table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>{{ __('#') }}</th>
                                        <th>{{ __('Username') }}</th>
                                                ...
                                                <label class="col-sm-4 control-label">{{ __('Action') }}<span class="text-danger">*</span></label>
                                                 <div class="col-sm-12">
                                                     <select class="form-control " name="status">
                                                        ...
                                                        <option value="2" <?php echo ($value->fault_status == 2)?"selected":"" ?> >{{__('No Accept')}}</option>
